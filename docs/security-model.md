...
**Schiavinato Sharing:**
- `manual_spec/`: Manual protocol specification
- `software_spec/`: Digital envelope specification
- `test_vectors/`: Canonical test vectors
- `whitepaper/WHITEPAPER.tex`: Mathematical foundations and security analysis
