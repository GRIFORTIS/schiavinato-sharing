...
> **This is the frozen test-vectors tree for v0.4.0.** It is preserved for reference only. This `v0.4.0` snapshot is intentionally partial and only archives the released vector materials. The live test-vectors workspace is in [`../../../test_vectors/README.md`](../../../test_vectors/README.md).
