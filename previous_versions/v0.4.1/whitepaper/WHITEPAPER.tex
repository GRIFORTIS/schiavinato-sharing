...
% --- Version ---
\newcommand{\SchiavinatoSharingVersion}{v0.4.1}
...
\author{
    \textbf{Renato Schiavinato Lopez}\thanks{\textbf{WARNING: EXPERIMENTAL SOFTWARE.} \textbf{DO NOT USE IT FOR REAL FUNDS!} Schiavinato Sharing specification and implementations have \textbf{NOT} been audited. Use for testing, learning, and experimentation only. Responsible disclosure: \texttt{security@grifortis.com} (security policy: \url{https://github.com/GRIFORTIS/.github/blob/main/SECURITY.md}). Canonical specification and reference implementations: \url{https://github.com/GRIFORTIS/schiavinato-sharing}. Licensed under CC BY 4.0.} \\
    GRIFORTIS \\
    \texttt{https://grifortis.com}
}
\date{\today\\\SchiavinatoSharingVersion}
...
\begin{itemize}[noitemsep]
    ...
    \item Extensive automated tests with reproducible test vectors
...
\paragraph{Usability evidence (scope).} This paper includes (i) an informal, early-stage manual usability pilot (Appendix~\ref{app:validation}) documenting re-learnability and documentation-driven performance, and (ii) supplementary demonstration material for the current manual workflow hosted in the project specification repository (see the ``Supplementary Material'' section in the repository README).\footnote{\url{https://github.com/GRIFORTIS/schiavinato-sharing}} These artifacts support clarity and reproducibility, but they are not controlled usability studies and should not be treated as population-level evidence.

\paragraph{Implementation status.} Multiple MIT-licensed reference implementations enable independent verification:
\begin{itemize}[noitemsep]
    \item JavaScript/TypeScript: npm package \texttt{@grifortis/\allowbreak schiavinato-sharing}
    \item HTML: offline single-file tool
    \item Python: library implementation
\end{itemize}
All are experimental, unaudited, and \textbf{must not} be used for significant real-world holdings.

\paragraph{Test vectors.} Version-scoped test vectors in \texttt{test\_vectors/} enable cross-implementation compatibility validation:
\begin{itemize}[noitemsep]
    \item \href{https://github.com/GRIFORTIS/schiavinato-sharing/blob/main/test_vectors/README.md}{\texttt{github.com/\allowbreak GRIFORTIS/\allowbreak schiavinato-sharing/\allowbreak blob/\allowbreak main/\allowbreak test\_vectors/\allowbreak README.md}}
    \item Released vectors under \texttt{test\_vectors/\allowbreak vX.Y.Z/}
\end{itemize}
Includes a 12-word 2-of-3 scheme with polynomial coefficients, share values, and expected checksums.

\paragraph{Repositories:}
\begin{itemize}[noitemsep]
    \item HTML: \url{https://github.com/GRIFORTIS/schiavinato-sharing-html}
    ...
    \item Spec: \url{https://github.com/GRIFORTIS/schiavinato-sharing}
\end{itemize}
...
We invite engagement from cryptographers, Bitcoin developers, usability researchers, and security auditors. Primary channels: GitHub Discussions (\url{https://github.com/GRIFORTIS/schiavinato-sharing/discussions}), and responsible disclosure via \texttt{security@grifortis.com} (see \url{https://github.com/GRIFORTIS/.github/blob/main/SECURITY.md}).
...
Renato Schiavinato Lopez, \textit{Schiavinato Sharing: Dual-Mode Threshold Secret Sharing for BIP39 Mnemonics}, GRIFORTIS, \SchiavinatoSharingVersion, \today. Available at \url{https://github.com/GRIFORTIS/schiavinato-sharing}.
...
\paragraph{Test configuration.} Participants recovered a test secret using a 4-of-\allowbreak 16 threshold scheme, significantly more complex than expected production deployments (e.g., 2-of-3, 3-of-5). Shares 1, 3, 5, and 10 used.
