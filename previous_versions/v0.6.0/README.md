# Schiavinato Sharing v0.6.0

This directory is the frozen archive snapshot for the `v0.6.0` release.

## Contents

- [`ROOT_README.md`](ROOT_README.md)
- [`ROOT_CHANGELOG.md`](ROOT_CHANGELOG.md)
- [`manual_spec/README.md`](manual_spec/README.md)
- [`manual_spec/CHANGELOG.md`](manual_spec/CHANGELOG.md)
- [`software_spec/README.md`](software_spec/README.md)
- [`software_spec/CHANGELOG.md`](software_spec/CHANGELOG.md)
- [`test_vectors/README.md`](test_vectors/README.md)
- [`test_vectors/schema.json`](test_vectors/schema.json)
- [`test_vectors/vectors.json`](test_vectors/vectors.json)
...
- This snapshot preserves the in-repo `v0.6.0` release materials before the live root docs moved to `v0.7.0`.
