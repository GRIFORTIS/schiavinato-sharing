...
> **This is the frozen root README from the v0.6.0 release.** It is preserved for reference inside [`README.md`](README.md). Some links were adjusted so they resolve from this archived location.
...
## Canonical documents
- **Whitepaper**: [PDF (signed release asset)](https://github.com/GRIFORTIS/schiavinato-sharing/releases/download/v0.6.0/WHITEPAPER-v0.6.0.pdf) | [LaTeX](whitepaper/WHITEPAPER.tex)
