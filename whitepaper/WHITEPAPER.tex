...
\author{
    \textbf{Renato Schiavinato Lopez}\thanks{\textbf{WARNING: EXPERIMENTAL SOFTWARE.} \textbf{DO NOT USE IT FOR REAL FUNDS!} Schiavinato Sharing specification and implementations have \textbf{NOT} been audited. Use for testing, learning, and experimentation only. Responsible disclosure: \texttt{security@grifortis.com}. Canonical specification and reference implementations: \url{https://github.com/GRIFORTIS/schiavinato-sharing}. Licensed under CC BY 4.0.} \\
    GRIFORTIS \\
...
We invite engagement from cryptographers, Bitcoin developers, usability researchers, and security auditors. Primary channels: Bitcoin-dev mailing list, GitHub Discussions (\url{https://github.com/GRIFORTIS/schiavinato-sharing/discussions}), and responsible disclosure via \texttt{security@grifortis.com} (see \url{https://github.com/GRIFORTIS/schiavinato-sharing/blob/main/.github/SECURITY.md}).
